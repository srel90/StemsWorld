...
class Bullet extends FlxSprite
{
	...
	public function shoot(Location:FlxPoint, Aim:Int,monsterTarget:FlxSprite):Void
	{
		...
		FlxAngle.rotatePoint(0, _speed, 0, 0, FlxAngle.getAngle(getMidpoint(_point), monsterTarget.getMidpoint(monsterTarget._point)), velocity);
